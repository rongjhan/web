...
async function runSingle(config,configType){
    ...
    var {dispatch} = store
        ...
        // var runConfigNow = findConfig(state,config.name,configType)
        ...
        try {
            ...
            console.log(`run config '${config.name}' with param`,producerParam,configOutput)
